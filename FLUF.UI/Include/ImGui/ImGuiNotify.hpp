...
// Warning: Requires ImGui docking with multi-viewport enabled
    ...
    #define NOTIFY_RENDER_OUTSIDE_MAIN_WINDOW \
        true // If true, the notifications will be rendered in the corner of the monitor, otherwise in the corner of the main window
#endif
...
class ImGuiToast
{
    ...
    public:
        ...
        void setSeperator(bool addSeparator) { this->addSeparator = addSeparator; }
    ...
    public:
        ...
        inline bool getSeperator() { return addSeparator; }
...
namespace ImGui
{
    ...
    inline void RenderNotifications()
    {
        ...
        for (size_t i = 0; i < notifications.size(); ++i)
        {
            ...
            const bool addSeperator = currentToast->getSeperator();
            ...
            SetNextWindowPos(
                ...
                ImVec2(1.0f, 1.0f));
#else
            // Set notification window position to bottom right corner of the main window, considering the main window size and location in relation to the
            // display
            ImVec2 mainWindowPos = GetMainViewport()->Pos;
            SetNextWindowPos(ImVec2(mainWindowPos.x + mainWindowSize.x - NOTIFY_PADDING_X, mainWindowPos.y + mainWindowSize.y - NOTIFY_PADDING_Y - height),
                             ImGuiCond_Always,
                             ImVec2(1.0f, 1.0f));
#endif
            ...
            // Here we render the toast content
            {
                ...
                {
                    if (wasTitleRendered && addSeperator)
                    {
                        Separator();
                    }
